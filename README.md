...
**Rezervacija karata s optimističkim transakcijama:**
```go
...
4. Dohvatiti ID nekog određenog koncerta (npr. 58b85029-af94-498e-ae3a-2fda2b5d6c5a) te izvršiti komandu koja se također nalazi u README.md datoteci u repozitoriju:  
```bash
